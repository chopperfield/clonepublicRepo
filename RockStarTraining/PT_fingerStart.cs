...
namespace RockStar.Training
{
    public partial class PT_fingerStart : Form
    {
        ...
        public void check_Instructor()
        {
            ...
            {
                //if (MessageBox.Show("Start Training ?", "Axioma agent", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                //{
                    insert_signin();
        ...
        bool berhasil_insert = false; //alasan kasi ini karena, threading si alertcontrol dan indikasi berhasil insert
