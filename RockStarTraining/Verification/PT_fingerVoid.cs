...
{
    public partial class PT_fingerVoid : Form
    {
        ...
        string _room;
        string _trainingUsage;
        public PT_fingerVoid(DataTable dt_finger,string clubName, string room ,string productName, string studentName, string instructorName, string trainingUsage)
        {
            InitializeComponent();            
            ...
            _room = room;
            _trainingUsage = trainingUsage;
        }

        private void PT_fingerVoid_Load(object sender, EventArgs e)
        {
        ...
        private void PT_fingerVoid_Shown(object sender, EventArgs e)
        {
            try
            {
        ...
        private void void_PrivateSession(string notes)
        {
            ...
            try
            {
                ...
                command.CommandText = "UPDATE module.trainingUsage SET voidBy=@voidBy,voidNote=@voidNote,voidDate=GETDATE() WHERE counter=@counter";
                command.Parameters.AddWithValue("@voidBy", Partner.Userid);
                command.Parameters.AddWithValue("@voidNote", notes);
                command.Parameters.AddWithValue("@counter", _trainingUsage);
        ...
        private void PT_fingerVoid_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void PT_fingerVoid_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void PT_fingerVoid_Resize(object sender, EventArgs e)
        {
            Invalidate();
        }

        private void PT_fingerVoid_FormClosed(object sender, FormClosedEventArgs e)
        {
