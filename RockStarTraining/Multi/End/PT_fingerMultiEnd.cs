...
{
    public partial class PT_fingerMultiEnd : Form
    {
        ...
        private void PT_fingerMultiEnd_Shown(object sender, EventArgs e)
        {
            try
            {
        ...
        private void PT_fingerMultiEnd_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void PT_fingerMultiEnd_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void PT_fingerMultiEnd_Resize(object sender, EventArgs e)
        {
            Invalidate();
        }

        private void PT_fingerMultiEnd_FormClosed(object sender, FormClosedEventArgs e)
        {
